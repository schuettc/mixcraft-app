        ...
        securityHeadersBehavior: {
          contentSecurityPolicy: {
            contentSecurityPolicy: [
              ...
              "connect-src 'self' https://api.mixcraft.app https://*.clerk.accounts.dev https://*.clerk.com https://clerk.mixcraft.app https://accounts.spotify.com https://api.music.apple.com https://*.apple.com",
              "img-src 'self' https://*.clerk.com https://img.clerk.com https://*.scdn.co https://i.scdn.co https://*.mzstatic.com data:",
              "frame-src https://*.clerk.accounts.dev https://clerk.mixcraft.app https://accounts.spotify.com https://challenges.cloudflare.com https://authorize.music.apple.com",
